...
Case 1: $m = \sqrt{3}$
\begin{align}
    \frac{\vec{m}^T  \vec{e}_2}{\abs{\vec{m}}\abs{\vec{e}_2}} = \frac{\sqrt{3}}{\sqrt{1+\sqrt{3}^2}} = \frac{\sqrt{3}}{2} \\
    \implies \frac{\vec{m}^T  \vec{e}_2}{\abs{\vec{m}}\abs{\vec{e}_2}} = \cos(30 \degree)
\end{align}
