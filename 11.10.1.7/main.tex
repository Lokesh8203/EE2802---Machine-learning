...
\solution Direction vector of y-axis is $\vec{y} = \myvec{0\\1}$ and direction vector of line is $\vec{l} = \myvec{1\\m}$.

\begin{align}
    \cos(30^\circ) = \frac{\vec{l}^T  \vec{y}}{|\vec{l}||\vec{y}|} = \frac{m}{\sqrt{1+m^2}} \\
