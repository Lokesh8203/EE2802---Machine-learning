...
\begin{align}
    \cos(30 \degree) = \frac{\vec{m}^{\top} \vec{e}_2}{\abs{\vec{m}}\abs{\vec{e}_2}} = \frac{m}{\sqrt{1+m^2}} \\
...
Case 1: $m = \sqrt{3}$
\begin{align}
    \frac{\vec{m}^{\top}  \vec{e}_2}{\abs{\vec{m}}\abs{\vec{e}_2}} = \frac{\sqrt{3}}{\sqrt{1+\sqrt{3}^2}} = \frac{\sqrt{3}}{2} \\
    \implies \frac{\vec{m}^{\top}  \vec{e}_2}{\abs{\vec{m}}\abs{\vec{e}_2}} = \cos(30 \degree)
\end{align}
