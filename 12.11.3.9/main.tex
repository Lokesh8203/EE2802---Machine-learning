...
If thie plane is passing through a point \vec{P}, then following will be satisfied

\begin{align}
	{P}: \brak{\vec{n}_1^{\top} - \lambda\vec{n}_2^{\top}}\vec{P} - \brak{{c}_1 + \lambda{c}_2} &= 0
\end{align}

Solving above equation would give us value of $\lambda$ which can be substituted to get final plane equation. 
