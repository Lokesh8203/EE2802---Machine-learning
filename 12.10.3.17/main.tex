...
\break
\solution Let's name the triangle $ABC$, where $\vec{A} = \myvec{2\\-1\\1}$, $\vec{B} = \myvec{1\\-3\\-5}$ and $\vec{C} = \myvec{3\\-4\\-4}$. So sides of triangle are:
...
\begin{align*}
    \vec{a}^\top \vec{b} &= 2\cdot(-1) + (-1)\cdot3 + 1\cdot5 = 0\\
    \vec{b}^\top \vec{c} &= (-1)\cdot(-1) + 3\cdot(-2) + 5\cdot(-6) = -35\\
    \vec{c}^\top \vec{a} &= (-1)\cdot2 + (-2)\cdot(-1) + (-6)\cdot1 = -6
\end{align*}
