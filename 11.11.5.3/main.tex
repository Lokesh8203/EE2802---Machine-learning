...
\begin{align}
    \myvec{\lambda_1&\lambda_2}\vec{V}\myvec{\lambda_1\\\lambda_2} + 2\vec{u}^{\top}\myvec{\lambda_1\\\lambda_2} + f &= 0\\
    2\vec{u}^{\top}\myvec{\lambda_1\\\lambda_2} = -\brak{f +  \myvec{\lambda_1&\lambda_2}\vec{V}\myvec{\lambda_1\\\lambda_2}}
\end{align}

Substituting $\vec{u}, \lambda_1, f, \vec{V}$, we get
\begin{align}
    2\myvec{0&-\frac{625}{12}}\myvec{\lambda_1\\\lambda_2} = -\myvec{\lambda_1&\lambda_2}\myvec{1&0\\0&0}\myvec{\lambda_1\\\lambda_2}\\
    \implies \lambda_2 = \frac{6}{625}\brak{\lambda_1}^2
\end{align}
