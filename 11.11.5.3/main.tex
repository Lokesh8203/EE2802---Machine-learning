...
At a point $18$ m from middle, i.e.
\begin{align}
    \vec{x} = 18\vec{e}_1 + \lambda_2\vec{e}_2
\end{align}

From equation \eqref{eq:parab1}, we get
\begin{align}
    \myvec{18&\lambda_2}\myvec{1&0\\0&0}\myvec{18\\\lambda_2} + 2\myvec{0 & -\frac{625}{12}}\myvec{18\\\lambda_2} &= 0\\
    \label{eq:1} \implies \lambda_2 = \frac{6}{625}{18}^2\\
