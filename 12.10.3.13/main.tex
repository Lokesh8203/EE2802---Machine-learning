...
\break
\solution The inner product of given unit vectors with sum of all unit vectors (Which is given to be 0) is zero
\begin{align}
    \vec{a}^\top(\vec{a} + \vec{b} + \vec{c}) &= 0 \\
    \Rightarrow (\vec{a} ^\top \vec{b} + \vec{a} ^\top \vec{c}) &= -1 \\
    \vec{b} ^\top (\vec{a} + \vec{b} + \vec{c}) &= 0 \\
    \Rightarrow (\vec{b} ^\top \vec{c} + \vec{b} ^\top \vec{a}) &= -1 \\
    \vec{c} ^\top (\vec{a} + \vec{b} + \vec{c}) &= 0 \\
    \Rightarrow (\vec{c} ^\top \vec{a} + \vec{c} ^\top \vec{b}) &= -1 \\
    \break
