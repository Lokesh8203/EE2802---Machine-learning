...
\begin{align*}
    ...
    \Rightarrow (\vec{a} \cdot \vec{b} + \vec{a} \cdot \vec{c}) &= -1 \\
    \vec{b} \cdot (\vec{a} + \vec{b} + \vec{c}) &= 0 \\
    \Rightarrow (\vec{b} \cdot \vec{c} + \vec{b} \cdot \vec{a}) &= -1 \\
    \vec{c} \cdot (\vec{a} + \vec{b} + \vec{c}) &= 0 \\
    \Rightarrow (\vec{c} \cdot \vec{a} + \vec{c} \cdot \vec{b}) &= -1 \\
    \break
